...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonItem, IonList, IonButton, IonButtons, ModalController, IonInput, IonText, IonSpinner } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonSpinner, IonText, IonButtons, IonButton, IonList, IonItem, IonContent, IonHeader, IonTitle, IonToolbar, IonInput, CommonModule, ReactiveFormsModule]
})
